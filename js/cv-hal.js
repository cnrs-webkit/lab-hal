...
function visibilite(thingId)
{
    ...
    if (document.getElementById('lab-hal-auteur').innerHTML== translate.compl){
        document.getElementById('lab-hal-auteur').innerHTML= translate.princ;
    } else {
        document.getElementById('lab-hal-auteur').innerHTML= translate.compl;
    }
}
...
function visibiliterevues(idrevues)
{
    ...
    if (document.getElementById('lab-hal-revue').innerHTML== translate.compl){
        document.getElementById('lab-hal-revue').innerHTML= translate.princ;
    } else {
        document.getElementById('lab-hal-revue').innerHTML= translate.compl;
    }
}
...
function visibiliteannee(idannee)
{
    ...
    if (document.getElementById('lab-hal-annee').innerHTML== translate.compl){
        document.getElementById('lab-hal-annee').innerHTML=  translate.princ;
    } else {
        document.getElementById('lab-hal-annee').innerHTML=  translate.compl;
    }
}
...
function visibiliteinst(idinst)
{
    ...
    if (document.getElementById('lab-hal-inst').innerHTML== translate.compl){
        document.getElementById('lab-hal-inst').innerHTML=  translate.princ;
    } else {
        document.getElementById('lab-hal-inst').innerHTML=  translate.compl;
    }
}
...
function visibilitelab(idlab)
{
    ...
    if (document.getElementById('lab-hal-lab').innerHTML== translate.compl){
        document.getElementById('lab-hal-lab').innerHTML=  translate.princ;
    } else {
        document.getElementById('lab-hal-lab').innerHTML=  translate.compl;
    }
}
...
function visibilitedept(iddept)
{
    ...
    if (document.getElementById('lab-hal-dept').innerHTML== translate.compl){
        document.getElementById('lab-hal-dept').innerHTML=  translate.princ;
    } else {
        document.getElementById('lab-hal-dept').innerHTML=  translate.compl;
    }
}
...
function visibiliteequipe(idequipe)
{
    ...
    if (document.getElementById('lab-hal-equipe').innerHTML== translate.compl){
        document.getElementById('lab-hal-equipe').innerHTML=  translate.princ;
    } else {
        document.getElementById('lab-hal-equipe').innerHTML=  translate.compl;
    }
}
...
function visibilitedisci(iddisci,idgraph,idtri)
{
    ...
    var plot1 = jQuery.jqplot ('lab-hal-piedisci', [data],
        {
            grid: {
                drawBorder: false,
                drawGridlines: false,
    ...
    if (document.getElementById('lab-hal-disci').innerHTML== translate.graph){
        document.getElementById('lab-hal-disci').innerHTML= translate.liste;
    } else {
        document.getElementById('lab-hal-disci').innerHTML= translate.graph;
    }
}
...
function visibilitekey(idkey,idsuite,idtri)
{
    ...
    if (document.getElementById('lab-hal-key').innerHTML== translate.compl){
        document.getElementById('lab-hal-key').innerHTML= translate.nuage;
    } else {
        document.getElementById('lab-hal-key').innerHTML= translate.compl;
    }
}
